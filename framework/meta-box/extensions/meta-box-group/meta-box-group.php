...
if ( class_exists( 'RWMB_Field' ) && ! class_exists( 'RWMB_Group_Field' ) ) {
	require_once ( get_template_directory() . '/framework/meta-box/extensions/meta-box-group/class-rwmb-group-field.php' );
}
...
class RWMB_Group
{
	...
	function __construct()
	{
		...
		// commented above line as file is loaded at top
